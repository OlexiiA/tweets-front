...
import { registerUser, checkIsAuth } from '../redux/auth/authSlice';
...
const RegisterPage = () => {
  ...
  return (
    <form onSubmit={(e) => e.preventDefault()} className='w-1/4 h-60 mx-auto mt-40'>
      ...
      <Link to='/login' className='flex justify-center items-center text-xs text-white mt-4 hover:text-blue-700'>
        Have an account? LogIn <span className='text-blue-700 ml-1'>here</span>
      </Link>
